      ...
      <div className="w-full px-10">
        <div className="bg-gray-100 p-4 rounded-lg shadow-md transition-all duration-300 relative">
          <div className="mb-4 flex gap-4">
            ...
            <div className="w-1/4">
              ...
              >
                ...
                {patients.map((patient) => (
                  <option key={patient.id} value={patient.paciente}>
                    {patient.paciente}
                  </option>
                ))}
              </select>
            ...
            <div className="w-1/4">
              ...
              >
                ...
                {patients.map((patient) => (
                  <option key={patient.id} value={patient.practicas}>
                    {patient.practicas}
                  </option>
                ))}
              </select>
            ...
            <div className="w-1/4">
              ...
              >
                ...
                {patients.map((patient) => (
                  <option key={patient.id} value={patient.obraSocial}>
                    {patient.obraSocial}
                  </option>
                ))}
              </select>
            ...
            <div className="w-1/4">
              ...
              >
                ...
                {patients.map((patient) => (
                  <option key={patient.id} value={patient.institucion}>
                    {patient.institucion}
                  </option>
                ))}
              </select>
          ...
          <button
            ...
            className="absolute -mb-6 bottom-2 right-4 sm:bottom-8 sm:right-8 p-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition duration-200"
          >
            <Plus size={24} />
          </button>
        </div>
